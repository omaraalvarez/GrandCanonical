...
def Mezei(ChemPot, h, L, T, R_Cut = 3.0):
    ...
    print("< E / N > = %.6f + %.6f" % (stat.mean(Energy_Array), stat.pstdev(Energy_Array)) )
    print("< P > = %.6f + %.6f" % (stat.mean(Pressure_Array), stat.pstdev(Pressure_Array)) )
    print("< Density > = %.6f + %.6f " % (stat.mean(Density_Array), stat.pstdev(Density_Array)) )
    print("< N > = %.6f + %.6f " % (V*stat.mean(Density_Array), V*stat.pstdev(Density_Array)) )
    print(" ")
